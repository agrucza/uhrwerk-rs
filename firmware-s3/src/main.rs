...
/// 2026-08-26: one mic test armed it, an 11 h soak burned 80 %).
/// MUST run while the session's clocks are still up - see the hook's
/// call site in `run_session` for the ordering evidence. The next
