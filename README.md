...
| RTC + alarms/timers (PCF85063) | working | working | working |
| Light sleep / wake | working | working | working |
| Storage - internal flash | working | working | working |
| Storage - SD card | working | no slot | boot-probe only (hotplug planned) |
...
| LoRa (SX1262) | n/a | n/a | not started |
| GPS (MIA-M10Q) | n/a | n/a | not started |
| NFC (ST25R3916) | n/a | n/a | not started |
